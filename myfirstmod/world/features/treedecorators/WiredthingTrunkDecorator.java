...
public class WiredthingTrunkDecorator extends TrunkVineDecorator {
	public static Codec<WiredthingTrunkDecorator> CODEC = Codec.unit(WiredthingTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wiredthing_tree_trunk_decorator", DECORATOR_TYPE));
	}

...
public class MossyforestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<MossyforestTrunkDecorator> CODEC = Codec.unit(MossyforestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("mossyforest_tree_trunk_decorator", DECORATOR_TYPE));
	}

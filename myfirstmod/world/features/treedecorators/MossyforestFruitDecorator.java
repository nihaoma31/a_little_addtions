...
public class MossyforestFruitDecorator extends CocoaDecorator {
	public static Codec<MossyforestFruitDecorator> CODEC = Codec.unit(MossyforestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("mossyforest_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public MossyforestFruitDecorator() {
		super(0.2f);
	}

...
public class CherrybutbetetrTrunkDecorator extends TrunkVineDecorator {
	public static Codec<CherrybutbetetrTrunkDecorator> CODEC = Codec.unit(CherrybutbetetrTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("cherrybutbetetr_tree_trunk_decorator", DECORATOR_TYPE));
	}
